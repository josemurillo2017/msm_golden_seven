Rails.application.routes.draw do
  ...
  get("/create_movie", { :controller => "movies", :action => "create_form" })
  get("/create_actor", { :controller => "actors", :action => "create_form" })
  get("/create_director", { :controller => "directors", :action => "create_form"})
